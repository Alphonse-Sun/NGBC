...
class Base extends Model
{
    ...
    //会员存款状态
    const DRWING_STATUS_ONE = 1;
    const DRWING_STATUS_TWO = 2;
    const DRWING_STATUS_THREE = 3;

    static public $DRAWING_STATUS = [
        self::DRWING_STATUS_ONE => '待确认',
        self::DRWING_STATUS_TWO => '成功',
        self::DRWING_STATUS_THREE => '失败'
    ];

    //会员充值状态
    const RECHARGE_STATUS_ONE = 1;
    const RECHARGE_STATUS_TWO = 2;
    const RECHARGE_STATUS_THREE = 3;

    static public $RECHARGE_STATUS = [
        self::RECHARGE_STATUS_ONE => '待确认',
        self::RECHARGE_STATUS_TWO => '成功',
        self::RECHARGE_STATUS_THREE => '失败'
    ];
}
