...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/wap/theme5/css/swiper.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/wap/theme5/css/messenger.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/wap/theme5/css/messenger-theme-flat.css')); ?>">
    <link href="<?php echo e(asset('/wap/theme5/css/style2.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('/wap/theme3/css/my.css')); ?>" rel="stylesheet" />
    <script type="text/javascript" src="<?php echo e(asset('/wap/theme5/js/jquery-1.11.3.min.js')); ?>"></script>
    <script src="<?php echo e(asset('wap/theme5/js/CUnits.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('wap/theme5/js/wapMain.js')); ?>"></script>
