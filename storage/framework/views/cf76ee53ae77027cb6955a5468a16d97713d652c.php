<?php $__env->startSection('content'); ?>
    ...
    <div class="row apiList clearfix">
        ...
        <div class="col-xs-2">
            ...
            <div class="text-center">
                <label class="pull-left">通用额度</label>
                <div class="pull-right">
                    <span>0</span>
                    <a href="#" data-uri="<?php echo e(route('api.credit_all')); ?>" class="refresh" style="vertical-align: top" id="ty"></a>
                </div>
            </div>
        </div>
        <?php $__currentLoopData = $apis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-xs-2">
                ...
                <div class="text-center">
                    <label class="pull-left"><?php echo e($item->api_name); ?></label>
                    <div class="pull-right">
                        <span><?php echo e($item->api_money); ?></span>
                        <a href="#" data-uri="<?php echo e(route('api.credit')); ?>?api_name=<?php echo e($item->api_name); ?>" class="refresh" style="vertical-align: top"></a>
                    </div>
                </div>
            </div>
