    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" action="<?php echo e(route('black_list_ip.store')); ?>" method="post">
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                &nbsp;<a href="<?php echo e(route('black_list_ip.index')); ?>" class="btn btn-info">返回</a>
                            </div>
                        </div>
                    </div>
                </form>
